...
// So in this script,
// for each race,
// we'll be using the naive algorithm
// to create a ranked list of picks
// and then comparing those picks
// against the scores of people who won! Yay!
